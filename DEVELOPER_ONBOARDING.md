...
│   ├── GameManager.swift     # ChessGameState - core game logic
│   ├── ChessCoachAPI.swift   # Backend API client
│   ├── RuleEngine.swift      # Chess rules validation
...
│   ├── FeatureFlags.swift
│   └── Secrets.swift         # ⚠️ Generated by setup.sh, DO NOT commit
├── .env.example              # Environment variable template
├── setup.sh                  # Setup script to generate Secrets.swift
...
3. Should see "✅ Success" if backend is reachable
